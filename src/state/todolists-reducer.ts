...
export type TodolistsActionsType = RemoveTodolistACType | AddTodolistACType
    | ChangeTodolistTitleACType | ChangeTodolistFilterACType | SetTodolistsACType
    | SetAppStatusACType | ChangeTodolistEntityStatusACType
...
export const addTodolistTC = (title: string) => async (dispatch: Dispatch<TodolistsActionsType | SetAppErrorACType>) => {
